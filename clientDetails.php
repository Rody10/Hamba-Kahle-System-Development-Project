...
<header>
        ...
        <div class="cart">
            <button type="button" class="btn"><a href="maintainClient.php" style="text-decoration: none; color: black;">BACK</a></button>
        </div>
    </header>
...
<h1 style="color: rgb(240, 127, 35); padding-left: 200px; padding-top: 50px; font-size: 45px;">Details</h1>
    ...
    $query = "SELECT * FROM teamvelox.client where clientId = $id"; 
