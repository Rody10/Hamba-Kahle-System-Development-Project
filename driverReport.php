...
<header>
    ...
    <h1 style="color: rgb(240, 127, 35); padding-left: 200px; padding-top: 50px; font-size: 45px;">Driver Report</h1>
    <br>
    ...
    $query = "SELECT * FROM teamvelox.driver Order by firstName";
