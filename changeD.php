...
<?php
    ...
    $query = "UPDATE teamvelox.driver SET firstName = '$firstName', lastName = '$lastName', contactNumber= '$contact', homeTown= '$address', driverId = '$driverId' WHERE driverId = $id";
...
<div class='main'>
    <div class='center'>
      <div class='content'>
        ...
        <div class='line'></div>
        <button for='click' class='close-btn'><a href='maintainDriver.php' style='text-decoration: none; color: white;'>Close</a></button>
      </div>
    </div> 
    </div> 
</body>
