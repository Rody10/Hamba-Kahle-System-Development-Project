...
<header>
  ...
  <body>
  <h1 style="color: rgb(240, 127, 35); padding-left: 200px; padding-top: 50px; font-size: 45px;">Vehicles</h1>
    <br>
...
$query = "SELECT registrationNumber, make, model FROM teamvelox.vehicle"; 
...
while($row = mysqli_fetch_array($result)){
    ...
    echo "<td>" . "<a href =\"vehicleDetails.php?id=" . $row['registrationNumber'] . "\"> <i class=\"fa fa-file-text-o\" style=\"color: rgba(40, 189, 73, 0.938);\"></i></a>" . "</td>";
    echo "<td>" . "<a href =\"vehicleDelete.php?id=" . $row['registrationNumber'] . 
    "\" onClick=\"return confirm('Are you sure you want to remove " . strtoupper($row['model']) . " " .
    strtoupper($row['registrationNumber']) . " from Vehicles?');\"><i class=\"fa fa-times-circle-o\" style=\"color: red;\"></i></a>" . "</td>";
    echo "</tr></tbody>";
}
echo "</table>";
