...
<h1 style="color: rgb(240, 127, 35); padding-left: 200px; padding-top: 50px; font-size: 45px;">Details</h1>
    ...
    $query = "SELECT * FROM teamvelox.depot where depotId = $id"; 
    ...
    while($row = mysqli_fetch_array($result)){
        ...
        echo "<h3>" . $row['depotName'] . "</h3>" . "<br>";
        echo "<strong>Depot Name: </strong>" . $row['depotName'] . "<br>"; 
        echo "<strong>Depot Address: </strong>" . $row['depotAddress'] . "<br>";
        echo "<strong>Town: </strong>" . $row['town'] . "<br>"; 
        echo "<strong>Rooms Available: </strong>" . $row['roomsAvailable'] . "<br>";
