...
<header>
  ...
  <body>
  <h1 style="color: rgb(240, 127, 35); padding-left: 200px; padding-top: 50px; font-size: 45px;">Clients</h1>
    <br>
...
$query = "SELECT clientId, firstName, lastName, contactNumber, emailAddress FROM teamvelox.client"; 
...
while($row = mysqli_fetch_array($result)){
    ...
    echo "<td>" . "<a href =\"clientDetails.php?id=" . $row['clientId'] . "\"> <i class=\"fa fa-file-text-o\" style=\"color: rgba(40, 189, 73, 0.938);\"></i></a>" . "</td>";
    echo "<td>" . "<a href =\"clientDelete.php?id=" . $row['clientId'] . 
    "\" onClick=\"return confirm('Are you sure you want to remove " . strtoupper($row['firstName']) . " " .
    strtoupper($row['lastName']) . " from Clients?');\"><i class=\"fa fa-times-circle-o\" style=\"color: red;\"></i></a>" . "</td>";
    echo "</tr></tbody>";
}
echo "</table>";
