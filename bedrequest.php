...
$query = mysqli_query($connection, "INSERT INTO teamvelox.daytrip (driverName, driverID, depotName, location, startDate, endDate) 
VALUES('$driverName', '$driverId', '$depotName', '$town', '$startDate', '$endDate')")          
...
<div class='main'>
    <div class='center'>
      <div class='content'>
        ...
        <p>Bed Request has been successfully made.</p>
        <div class='line'></div>
        <button for='click' class='close-btn'><a href='driver.php' style='text-decoration: none; color: white;'>Close</a></button>
      </div>
    </div> 
    </div> 
</body>
