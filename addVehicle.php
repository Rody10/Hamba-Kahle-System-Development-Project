...
$query = mysqli_query($connection, "INSERT INTO teamvelox.vehicle (registrationNumber, dateOfPurchase, make, model, year, numberOfPassengers, licenceCode) 
VALUES('$registrationNumber', '$datePurchased', '$make', '$model', '$year', '$numberOfPassengers', '$requiredLicense')")          
