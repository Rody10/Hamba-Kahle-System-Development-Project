...
<h1 style="color: rgb(240, 127, 35); padding-left: 200px; padding-top: 50px; font-size: 45px;">Details</h1>
    ...
    while($row = mysqli_fetch_array($result)){
        ...
        echo "<strong>Driver ID: </strong>" . $row['driverId'] . "<br>"; 
        echo "<strong>Home Address: </strong>" . $row['homeTown'] . "<br>"; 
        echo "<strong>Date Employed: </strong>" . $row['dateEmployed'] . "<br>";
        echo "<strong>License Code: </strong>" . $row['licenseCode'] . "<br>";
    }
    echo "</div>";
    mysqli_close($conn);
