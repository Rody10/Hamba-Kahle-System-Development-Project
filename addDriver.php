...
$licensecode = $_REQUEST['licensecode'];
...
$query = mysqli_query($connection, "INSERT INTO teamvelox.driver (firstName, lastName, dateOfBirth, contactNumber, dateEmployed, homeTown, licenseCode) 
VALUES('$firstname', '$lastname', '$date', '$contactnumber', '$dateemployed', '$homeaddress', '$licensecode')")          
...
<div class='main'>
    <div class='center'>
      <div class='content'>
        ...
        <p>Vehicle has been successfully made.</p>
        <div class='line'></div>
        <button for='click' class='close-btn'><a href='managers.php' style='text-decoration: none; color: white;'>Close</a></button>
      </div>
    </div> 
    </div> 
</body>
